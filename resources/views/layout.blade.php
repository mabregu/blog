...
<head>
    ...
    <meta name="description" content="@yield('meta-description', __('This is a blog'))">
    ...
    <section class="footer">
		<footer>
			<div class="container">
				...
				<p>© 2021 - {{ config('app.name') }}. All Rights Reserved. Designed & Developed by <span class="c-white"><a href="http://mabregu.online" target="_blank" rel="noopener noreferrer">mabregu.online</a></span></p>
